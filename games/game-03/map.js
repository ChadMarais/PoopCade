...
export const ROCK_INSTANCES = Object.freeze([
  ...
  Object.freeze({ id: "ROCK D", assetId: "rock-cluster-01", x: 900, y: 1480, width: 300, height: 300, rotation: 0 }),
...
export const SATELLITE_INSTANCES = Object.freeze([
  Object.freeze({ id: "SATELLITE RELAY WEST", assetId: "satellite-relay-01", kind: "satellite", x: 500, y: 1200, width: 460, height: 460, rotation: 0 }),
  Object.freeze({ id: "SATELLITE RELAY EAST", assetId: "satellite-relay-01-left", kind: "satellite", x: 2700, y: 1200, width: 460, height: 460, rotation: 0 }),
]);
